...
$(function(){
	$(".btn1").click(function(){
		...
		//모든 <select 요소의 첫 번째 <option 요소를 선택
		$("select option:first-child").css("background-color","blue");
		//모든 select 요소의 세 번째 <option 요소를 선택
		$("select option:nth-child(3)").css("background-color","yellow");
    });
});
</script>
</head>
<div class="card card-primary">
	<div class="card card-warning">
		...
		<div class="card-body">			
			<form>
    			<button type="button" class="btn btn-primary btn1">btn1</button>
